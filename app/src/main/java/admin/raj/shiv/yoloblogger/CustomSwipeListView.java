...
package admin.raj.shiv.yoloblogger;
 ...
 * the associated with this view.
 *
 * @author xyczero
 */
public class CustomSwipeListView extends ListView {
    private static final String TAG = "admin.raj.shiv.yoloblogger.customswipelistview";

    /**
     * Indicates the tag of the adapter's itemMainView.
     */
    public static final String ITEMMAIN_LAYOUT_TAG = "admin.raj.shiv.yoloblogger.customswipelistview.itemmainlayout";

    /**
     * Indicates the tag of the adapter's swipeLeftView.
     */
    public static final String ITEMSWIPE_LAYOUT_TAG = "admin.raj.shiv.yoloblogger.customswipelistview.swipeleftlayout";
